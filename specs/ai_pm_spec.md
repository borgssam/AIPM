...
*   **요구사항 2.1 (태스크 생성 및 수정 UI):** 칸반 보드에서 신규 할 일(태스크)을 직접 추가할 수 있고, 카드 클릭 시 수정을 지원해야 한다. 태스크 생성/수정 시 제목, 설명, 상태, 우선순위, 소속 에픽 링크를 설정할 수 있고, **기능검수/품질검수 수행 여부 체크박스 및 품질조건 내용**을 직접 입력하여 저장할 수 있어야 한다. 저장된 품질조건은 나중에 품질검수명세서 화면의 "품질조건" 컬럼에서 즉시 연계 조회 및 모니터링할 수 있도록 지원해야 한다.
