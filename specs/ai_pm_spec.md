...
*   **요구사항 4.6 (인공지능 플링크 버튼):** 칸반보드 뷰 상단에 "새 할 일 추가" 버튼 바로 옆에 "인공지능 플링크" 버튼이 배치된다. PM 권한자가 이 버튼을 클릭하면 AI 기획서/명세 분석 및 일정 자동 일괄 생성 화면(프로젝트 생성 탭)으로 즉시 포커스 이동하여 신속하게 AI 일정 계획(Planning) 프로세스를 연계 진행할 수 있도록 지원해야 한다.
